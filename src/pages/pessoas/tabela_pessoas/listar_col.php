...
<div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
  <header class="mb-auto">
    ...
    <div>
      <nav class="nav nav-masthead justify-content-center float-md-end">
        <a class="nav-link fw-bold py-1 px-0 active" aria-current="page" href="tabela_pessoas/listar_alunos.php">Alunos</a>
        <a class="nav-link fw-bold py-1 px-0" href="tabela_pessoas/index.php">Professores</a>
        <a class="nav-link fw-bold py-1 px-0" href="tabela_pessoas/index.php">Colaboradores</a>
      </nav>
    </div>
